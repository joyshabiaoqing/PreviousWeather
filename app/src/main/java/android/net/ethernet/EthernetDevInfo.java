...
public class EthernetDevInfo implements Parcelable {
     ...
     */
    public NetworkInfo setDetailedState(DetailedState state, String reason,
            String extraInfo) {
    ...
    private void setDetailedState_l(DetailedState state, String reason, String extraInfo) {
        mOut.setDataPosition(0);
